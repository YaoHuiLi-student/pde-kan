...
parser.add_argument('--skip_aggregation', default='concatenation',
...
parser.add_argument("--list_dir", default="/home/ubuntu/G-CASCADE-main/data/ACDC/lists_ACDC/")
parser.add_argument("--root_dir", default="/home/ubuntu/G-CASCADE-main/data/ACDC/")
parser.add_argument("--volume_path", default="/home/ubuntu/G-CASCADE-main/data/ACDC/test/")
...
if args.encoder == 'PVT':
    ...
    net = MERIT_GCASCADE(n_class=args.num_classes, img_size_s1=(args.img_size, args.img_size), img_size_s2=(224, 224),
                         k=11, padding=5, conv='mr', gcb_act='gelu', skip_aggregation=args.skip_aggregation).cuda()
else:
