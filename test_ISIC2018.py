...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder', type=str, default='MERIT', help='Name of encoder: PVT or MERIT')
    parser.add_argument('--skip_aggregation', type=str, default='concatenation',
    ...
    if opt.encoder == 'PVT':
        model = PVT_GCASCADE(n_class=1, img_size=opt.img_size, k=11, padding=5, conv='mr', gcb_act='gelu',
    ...
    for _data_name in ['test']:
        ...
        ##### put data_path here #####
        data_path = '/home/ubuntu/G-CASCADE-main/data/ISIC2018-4/test/{}'.format(_data_name)
        ...
        for i in range(num1):
            ...
            # eval Dice
            res = F.upsample(res1, size=gt.shape, mode='bicubic', align_corners=False)
        ...
        get_metrics_and_print(np.asarray(gts), np.asarray(preds), method=method_name, testset='ISIC2018_' + _data_name,
                              write=True)
