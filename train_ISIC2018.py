...
def test(model, path, dataset):
    ...
    for i in range(num1):
        ...
        res = F.upsample(res1, size=gt.shape, mode='bilinear',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str,
                        default='/home/ubuntu/G-CASCADE-main/data/ISIC2018-4/train/',
                        help='path to train dataset')

    parser.add_argument('--test_path', type=str,
                        default='/home/ubuntu/G-CASCADE-main/data/ISIC2018-4/test/',
    ...
    if opt.encoder == 'PVT':
        model = PVT_GCASCADE(n_class=1, img_size=opt.img_size, k=11, padding=5, conv='mr', act='gelu',
