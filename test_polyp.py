...
if __name__ == '__main__':
    ...
    if opt.encoder == 'PVT':
        ...
        model = MERIT_GCASCADE(n_class=1, img_size_s1=(256, 256), img_size_s2=(224, 224), k=11, padding=5, conv='mr',
                               gcb_act='gelu', skip_aggregation=opt.skip_aggregation)
    else:
    ...
    for _data_name in ['CVC-ClinicDB', 'Kvasir', 'CVC-ColonDB', 'CVC-300', 'ETIS-LaribPolypDB']:
        ...
        ##### put data_path here #####
        data_path = '/home/ubuntu/G-CASCADE-main/data/polyp/TestDataset/TestDataset/{}'.format(_data_name)
